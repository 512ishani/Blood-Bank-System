...
public class FunFact {
	...
	void Activities() {
		...
		switch(option) {
		case 1:
			//printing the upcoming blood drives
			System.out.println("");
			System.out.println("The blood donation drives the upcoming month are:");
			System.out.println("");
			System.out.println("11th November-Shivaji Nagar Blood Bank Centre");
			System.out.println("");
			System.out.println("16th November-Vaibhav Nagar Blood Bank Centre");
			System.out.println("");
			System.out.println("21st Novemebr-Katraj Blood Bank Centre");
			System.out.println("");
			System.out.println("27th November-ChinchwadGaon");
			System.out.println("");
			break;
		case 2:
			//receivers stories 
	...
	int m=0;
	void quiz() {
		//quiz for the user to spread awareness 
		do {
