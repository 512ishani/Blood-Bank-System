...
class chatList{
	chat_Node head;
	chat_Node tail;
	  //storing all the questions in linked list
	chatList(){
		this.head=null;
		this.tail=null;
	}
...
class ChatSystem {
   ...
   //giving answers for the most frequently asked questions
     void questionsSet() {
    ...
    void freq() {
    	//create a hashmap to store the questions and answers in the the from of key value pairs
